...
export default {
  ...
  pages: [
    {
      name: "Examples",
      pages: [
        {name: "Dashboard", path: "./pages/panell"},
    ...
    },
    {
      name: "About",
      pages: [
        {name: "Les dades", path: "./pages/dades"},
        {name: "Algo més", path: "./pages/todo"}
      ]
    }
  ],
  ...
  footer: "La visualització pot transformar la difusió de les dades obertes i revolucionar la transparència i el retiment de comptes. Dóna suport a la nostra missió.", // what to show in the footer (HTML)
